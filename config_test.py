...
ARRAY_SEPARATION = 0.0      # separation between arrays (m)
ACTIVE_ARRAYS = 4           # number of active arrays
N_MICROPHONES = ROWS*COLUMNS*ACTIVE_ARRAYS
MAX_RES_X = 30              # max resultion in x-direction (scanning window)
MAX_RES_Y = 30              # max resultion in y-direction (scanning window)
Z = 1.0                     # z-position of scanning window
VIEW_ANGLE = 59.0           # view angle of camera image in horizontal direction
SKIP_N_MICS = 1
...
mode = 1
modes = 7                   # total number of modes
plot_setup = 1              # if 1: plot array setup in calc_r_prime. if 0: don't plot
...
# source1
f_start1 = 1000           # lowest frequency that the source emitts
f_end1 = 2000               # highest frequency that the source emitts
f_res1 = 2                 # resolution of frequency
